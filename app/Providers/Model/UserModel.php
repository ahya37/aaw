...
class UserModel extends ServiceProvider
{
    ...
    public function getProfile($id)
    {
        $sql = DB::table('users as a')
                ...
                ->select('a.*','b.name as village','b.id as village_id','c.name as district','c.id as district_id','d.name as regency','d.id as regency_id','e.name as province','e.id as province_id')
                ->where('a.id', $id)->first();
        return $sql;
    }
}
